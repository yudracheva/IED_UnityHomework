...
namespace Services.Loot
{
    public class LootService : ILootService
    {
        ...
        public LootService(ILootSpawner lootSpawner, IRandomService randomService, IStaticDataService staticDataService,
            IEnemySpawner enemySpawner, LootContainer lootContainer)
        {
